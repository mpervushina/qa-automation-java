...
public class AppTest {
    ...
    private static Stream<Arguments> dataForApplicationWithZeroValues() {
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource("dataForApplicationWithZeroValues")
    ...
    @Test
    @DisplayName("Успешный вывод ответа по ид заявки из файла")
